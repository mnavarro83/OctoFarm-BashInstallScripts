...
log_info "OctoFarm Installer Script for Debian/Cannonical variants. Tested on Debian 10 and 11 and on Ubuntu 20.04 and 21.04. Does not work and will not fix on Debian 9, as it is EOL; and before you ask I will not create support for any EOL OS. This script should only be executed by a system user with sudo privileges. Do NOT run as root. Report all issues to the this github: https://github.com/mnavarro83/OctoFarmInstallScript-RH.git/"
